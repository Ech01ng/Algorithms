/*
Program Description: A Menu Driven, C Program to help Bank customers manage their Personal Identification Number (PIN)
on an Automated Teller Machine (ATM).

{ORIGINAL USER DEFAULT PIN = 1234}

Credit to: Joshua (Y2 Computer Science Infrastructure Student) for the idea and concept of the program.
*/
