...
//Struct for the issue and resolution
...
//Struct for the product line key
...
//Struct for the product line node
...
//Struct for the product summary
...
int main(void) 
{
	//Create the product line logs for each line
